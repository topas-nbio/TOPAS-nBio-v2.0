...
// experimental
class DrSubDiffusiveAction{
public:
  DrSubDiffusiveAction() = default;
  virtual ~DrSubDiffusiveAction() = default;
...
public:
  ...
  inline void SetSubDiffusiveAction(DrSubDiffusiveAction*);
  ...
  inline void UseMaximumTimeBeforeReachingBoundary(bool flag = true){ fUseMaximumTimeBeforeReachingBoundary = flag; }
...
protected:
  ...
  // Process information
  struct DrITSubdiffusionState : public G4ITTransportationState{
  public:
    DrITSubdiffusionState();
    virtual ~DrITSubdiffusionState(){}
    virtual G4String GetType(){ return "DrITSubdiffusionState"; }
  ...
  DrSubDiffusiveAction* fpSubDiffusiveAction;
  //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  private:
  G4double fTrappedDiffCoef{0.};	//nm*nm/s
  G4double fJumpDiffCoef{0.};		//nm*nm/s
  //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
};


inline void DrTransportation_Subdiffusion_CTRW::SetSubDiffusiveAction(DrSubDiffusiveAction* SubDiffusiveAction){
  fpSubDiffusiveAction = SubDiffusiveAction;
}

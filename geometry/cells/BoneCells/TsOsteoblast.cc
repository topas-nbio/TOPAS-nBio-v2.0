...
TsOsteoblast::TsOsteoblast(TsParameterManager* pM, TsExtensionManager* eM, TsMaterialManager* mM, TsGeometryManager* gM,
...
TsOsteoblast::~TsOsteoblast()
{;}

void TsOsteoblast::ResolveParameters() {
...
G4VPhysicalVolume* TsOsteoblast::Construct()
{
	BeginConstruction();
